...
def answer_query(question: str, stream: bool = False) -> str:
    ...
    if stream:
        ...
        for chunk in client.complete_streaming_chat(messages):
            ...
            if content:
                ...
                # a small model can loop until it exhausts MAX_TOKENS — cut it short
                if guard.feed(content):
                    print(text_guard.DEGENERATION_NOTICE, end="")
    ...
    answer = text_guard.clean_answer(client.complete_chat(messages).choices[0].message.content)
